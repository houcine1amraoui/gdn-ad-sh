...
def compute_scores(config):
    ...
    actor2_test_errors = np.load(f"{eval_results_folder}/{model_name}/errors/actor2_test_errors.npy")
    actor1_test_errors = np.load(f"{eval_results_folder}/{model_name}/errors/actor1_test_errors.npy")
